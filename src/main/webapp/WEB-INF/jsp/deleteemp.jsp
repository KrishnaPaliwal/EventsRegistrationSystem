	...
	<form method="get" action="employee/delete">
		<center>
			...
			<table class="table1">
				...
				<tr>
					<td></td>
					<td><input type="reset" value="Reset" /><input type="submit" value="Delete" /> </td>
				</tr>

			</table>
			<a href="emp">Click this link to create new Employee</a> |
			<a href="evnt">Click this link to create new Event</a>
		</center>
	</form>
</body>
<head>
