	...
	<form method="get" action="event/save">
		<center>
			<table class="table1">
				...
				<tr>
					<th>New Event Creation Form</th>
				</tr>

				<tbody>
					<tr>
						<td>Event Id</td>
						<td><input type="text" name="eventId" value="1" /></td>
					</tr>
					<tr>
						<td>Event Title</td>
						<td><input type="text" name="eventTitle" value="" /></td>
					</tr>
					<tr>
				...
				<tfoot>
					<tr>
					<td></td>
						<td><input type="submit" value="Create New Event" /> <input
